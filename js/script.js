...
const toggleFeature = (e) => {
  ...
  console.log('Feat: ', currFeature, ' Targ:', e.target);
  if((e.target == currFeature) || (e.target.parentElement == currFeature) || (e.target.classList.contains('a-projectBar__imgCaption'))){ /// add condition for clicking text part of projectItem
    return;
  }
